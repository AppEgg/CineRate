...
// export const rateLimiterMiddleware = (points: number, durationSeconds: number) => {
//     const limiter = new RateLimiterRedis({
//         storeClient: redisClient,
//         points,
//         duration: durationSeconds,  // **saniyə ilə** veririk
...
//             res.set('X-RateLimit-Reset', String(Math.ceil(Date.now() / 1000 + ((rlRes.msBeforeNext ?? 0) / 1000))));
...
//   post: { points: 20, duration: 15 * 60 },   
//   search: { points: 50, duration: 15 * 60 }, 
// };
